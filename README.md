# Docker compose Nginx, PHP-FPM 8.1.6, Xdebug 3 and MariaDB

![docker](https://img.shields.io/badge/Docker-compose-brightgreen.svg)
![nginx](https://img.shields.io/badge/nginx-on_apline-brightgreen.svg)
![php](https://img.shields.io/badge/PHP_FPM-8.1.6-brightgreen.svg)
...
* Uses [PHP 8.1.6](https://www.php.net) for better performance, lower CPU and memory usage
