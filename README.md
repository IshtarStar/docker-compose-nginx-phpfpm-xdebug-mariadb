# Docker compose PHP FPM 8.2.3, Redis 7.0.9, Xdebug 3.2.0RC1, Nginx 1.23.3, and MariaDB 10.10.3

![docker](https://img.shields.io/badge/Docker-compose-brightgreen.svg)
![php](https://img.shields.io/badge/PHP_FPM-8.2.3-brightgreen.svg)
![redis](https://img.shields.io/badge/Redis-7.0.9-brightgreen.svg)
...
* Uses [PHP 8.2.3](https://www.php.net) for better performance, lower CPU and memory usage
* [Redis 7.0.9](https://redis.io) as session storage, database, cache, streaming engine, and message broker
